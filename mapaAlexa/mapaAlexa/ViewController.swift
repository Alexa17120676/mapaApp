...
class ViewController: UIViewController, UISearchBarDelegate, MKMapViewDelegate {
    ...
    func trazarRuta(coordenadasDestino: CLLocationCoordinate2D)   {
        ...
        direcciones.calculate { (respuesta, error) in
            ...
            let alerta2 = UIAlertController(title: "Distancia", message: "La distancia es de:  \(kilometros) kilometros", preferredStyle: .alert)
